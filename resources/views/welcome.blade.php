            ...
            <div class="col-md-12" data-aos="fade-up" data-aos-delay="400">
              ...
              <div class="row mb-4">
                <div class="col-md-7">
                  ...
                  <div>
                    <a href="{{ route('shop.index') }}" class="btn btn-white btn-outline-white py-3 px-5 rounded-0 mb-lg-0 mb-2 d-block d-sm-inline-block">Shop Now</a>
      ...
      <div class="site-section" id="products-section">
        <div class="container">
          ...
          <div class="row mb-5 justify-content-center">
                <div class="col-md-6 text-center">
                  <h3 class="section-sub-title">Popular Products</h3>
                  <h2 class="section-title mb-3">Shop More</h2>
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae nostrum natus excepturi fuga ullam accusantium vel ut eveniet aut consequatur laboriosam ipsam.</p>
                    <a href="{{ route('shop.index') }}" class="btn btn-black btn-outline-black ml-1 rounded-0 text-center">View More</a>
            </div>
